...
class Assignment(keystone_assignment.Driver):
    ...
    def get_trust(self, trust_id):
        ...
        trust_ref = session.query(DomainTrust).get(trust_id)
        return trust_ref.to_dict()
...
class RoleAssignment(sql.ModelBase, sql.DictBase):
    ...
    attributes = ['type', 'actor_id', 'target_id', 'role_id', 'inherited', 'domain_trust']
    ...
    domain_trust =  sql.Column(sql.String(64), default=False, nullable=True)
...
class DomainTrust(sql.ModelBase, sql.DictBase):
    __tablename__ = 'domaintrust'
    attributes = ['id', 'trustor_domain', 'trustee_domain', 'trust_type']
    id = sql.Column(sql.String(64), primary_key=True)
    trustor_domain= sql.Column(sql.String(64), nullable=False)
    trustee_domain = sql.Column(sql.String(64), nullable=False)
    trust_type = sql.Column(sql.String(64), nullable=False)
    __table_args__ = (sql.UniqueConstraint('trustee_domain', 'trustor_domain'), {})
